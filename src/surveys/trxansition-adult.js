  ...
  elements: [
    ...
    },
    {
      ...
      rows: [
        {
          value: "q30",
          text: "Who manages your health condition, for example help you remember to take your medicines, call in prescription refills, pick up meds from pharmacy, and make doctor appointments?",
        },
      ],
      alternateRows: true,
      isAllRowRequired: true,
