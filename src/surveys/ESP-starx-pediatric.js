export const json = {
  title: "Cuestionario para los adolescentes",
  logoPosition: "right",
  pages: [
    {
      name: "page0",
        ...
        },
        {
          ...
          rows: [
            ...
            },
            {
              value: "q18",
              text:
                "¿Qué tan fácil o difícil cree que será para usted pasar de la pediatría a la atención enfocada en adultos?",
            },
          ],
        },
      ],
  ...
  completedHtml:
    "<h2>Gracias por completar la cuestionario</h2></br><h2>Su puntaje de preparación es {score} </h2> </br> <h2> Póngase en contacto con su proveedor y sus padre(s)/tutor(es) para interpretar esta puntuación. </h2> </br><h2>Para obtener recursos sobre cómo mejorar sus habilidades, visite <a href = https://www.med.unc.edu/transition/transition-tools/copy_of_educational-handouts-for-trxansition-indextm/>nuestra página de recursos</a></h2>",
};
